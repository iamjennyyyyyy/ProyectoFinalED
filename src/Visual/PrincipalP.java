...
public class PrincipalP extends JFrame {
	...
	private JPanel getPanelLateral() {
		if (panelLateral == null) {
			...
			panelLateral.setBackground(Colores.getColor3());
	...
	private JButton getBtnSesion() {
		if (btnSesion == null) {
			...
			btnSesion.setBackground(Colores.getColor3());
	...
	private JButton getBtnGestion() {
		if (btnGestion == null) {
			...
			btnGestion.setBackground(Colores.getColor3());
	...
	private JButton getBtnReportes() {
		if (btnReportes == null) {
			...
			btnReportes.setBackground(Colores.getColor3());
...
//					a.setVisible(true);
			...
			btnAcerca.setBackground(Colores.getColor3());
...
//					lblAjustes.setForeground(Color.BLACK);
			...
			btnAjustes.setBackground(Colores.getColor3());
	...
	private JPanel getPanelSup() {
		if (panelSup == null) {
			...
			panelSup.setBackground(Colores.getColor2());
...
//					g.setVisible(true);
	...
	private JLabel getLblNewLabel_2() {
		if (lblNewLabel_2 == null) {
			...
			lblNewLabel_2.setBackground(Colores.getColor1());
